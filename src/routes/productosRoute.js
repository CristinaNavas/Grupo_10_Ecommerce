...
const validationsProductsCreate = require("../middlewares/validationsProductsCreate");
const validationsProductsEdit = require("../middlewares/validationsProductsEdit");
...
router.post("/create", upload.single("image"), validationsProductsCreate, productosController.productSave);

//Rutas Editar
router.get("/edit/:id/",productosController.productEdit);
router.put("/edit/:id/", upload.single("image"),validationsProductsEdit, productosController.productModify);
